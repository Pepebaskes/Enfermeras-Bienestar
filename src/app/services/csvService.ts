...
export const exportToCSV = (persons: Person[]): string => {
  const headers = [
    ...
    'Glucosa Horas Ayuno',
    'Glucosa Resultado',
    'Glucosa Fecha Hora Muestra',
    'Trigliceridos Horas Ayuno',
    'Trigliceridos Resultado',
    'Trigliceridos Fecha Hora Muestra',
    'Colesterol Horas Ayuno',
    'Colesterol Resultado',
    'Colesterol Fecha Hora Muestra',
    'Pantorrilla cm',
    'Brazo cm',
    'Cintura cm',
    'Discapacidad',
  ...
  const rows = persons.map(person => {
    ...
    return [
      ...
      escapeCSVValue(person.diagnostico || ''),
      escapeCSVValue(person.tratamiento || ''),
      escapeCSVValue(person.taSistolica?.toString() || ''),
      escapeCSVValue(person.taDiastolica?.toString() || ''),
      escapeCSVValue(person.frecuenciaRespiratoria?.toString() || ''),
      escapeCSVValue(person.temperatura?.toString() || ''),
      escapeCSVValue(person.escalaGlasgow?.toString() || ''),
      escapeCSVValue(person.grupoRiesgo || ''),
      ...
      escapeCSVValue(person.glucosaHorasAyuno?.toString() || ''),
      escapeCSVValue(person.glucosaResultado?.toString() || ''),
      escapeCSVValue(person.glucosaFechaHoraMuestra || ''),
      escapeCSVValue(person.trigliceridosHorasAyuno?.toString() || ''),
      escapeCSVValue(person.trigliceridosResultado?.toString() || ''),
      escapeCSVValue(person.trigliceridosFechaHoraMuestra || ''),
      escapeCSVValue(person.colesterolHorasAyuno?.toString() || ''),
      escapeCSVValue(person.colesterolResultado?.toString() || ''),
      escapeCSVValue(person.colesterolFechaHoraMuestra || ''),
      ...
      escapeCSVValue(person.discapacidad || ''),
      escapeCSVValue(person.nota || ''),
