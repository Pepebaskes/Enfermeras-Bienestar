...
export function PersonFormPage({ persons, profile, onSave }: PersonFormPageProps) {
  ...
  const handleSave = async (data: Partial<Person>) => {
    const newPerson: Person = {
      ...
      glucosaHorasAyuno: data.glucosaHorasAyuno,
      glucosaResultado: data.glucosaResultado,
      glucosaFechaHoraMuestra: data.glucosaFechaHoraMuestra,
      trigliceridosHorasAyuno: data.trigliceridosHorasAyuno,
      trigliceridosResultado: data.trigliceridosResultado,
      trigliceridosFechaHoraMuestra: data.trigliceridosFechaHoraMuestra,
      colesterolHorasAyuno: data.colesterolHorasAyuno,
      colesterolResultado: data.colesterolResultado,
      colesterolFechaHoraMuestra: data.colesterolFechaHoraMuestra,
